...
- [x] BUG CORRIGIDO: Modal de templates mostra "Nenhum template disponível" - corrigida função listAvailableTemplates para filtrar apenas templates do SPC Brasil (organizationId = 1), adicionados 2 testes de regressão, 119 testes aprovados, build sucesso
